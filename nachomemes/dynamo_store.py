...
class DynamoTemplateStore(Store):
    ...
    def _template_table(
        self, guild_id: str, populate: bool = True
    ...
    def _config_table(
        self, guild: Union[Guild, GuildConfig, None], populate: bool = True
    ) -> "boto3.resources.factory.dynamodb.Table":
        """
    ...
    def _init_table(
        self, table_name: str, keys=Sequence[str]
    ) -> "boto3.resources.factory.dynamodb.Table":
        table = self.dynamodb.create_table(
            ...
            # Puts the table in On-demand mode.
